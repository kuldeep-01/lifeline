...
const Appointment = () => {
  ...
  return docInfo && (
    <div>
      {/* ------------------doctor details----------------- */}
      <div className='flex fle-col sm:flex-roe gap-4'>
        <div>
          <img className='bg-primary w-full sm:max-w-72 rounded-lg' src={docInfo.image} alt="" />
        </div>

        <div className='flex-1 border vorder-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
